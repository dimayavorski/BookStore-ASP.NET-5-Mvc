namespace BookStore.DAL.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BookStore.DAL.EF.BookContext>
    {
        ...
        protected override void Seed(BookStore.DAL.EF.BookContext context)
        {
            ...
            context.Books.AddOrUpdate(new Book { Id = 3, Name = "Белый снег", Description = "В 1830 году Россию захватила вспышка холеры. Дорога к Москве была перекрыта из-за карантина, и Александр Сергеевич Пушкин оказался в вынужденном затворничестве в имении Большое Болдино. Болдинская осень войдёт в историю как самый продуктивный творческий период писателя. За три месяца он создал около пятидесяти произведений, в том числе и Повести Белкина. Книгу составляют предисловие От издателя и пять повестей: Выстрел, Метель, Гробовщик, Станционный смотритель и Барышня - крестьянка. Издание выполнено с тиснением на обложке, содержит ляссе (ленточку-закладку).", AuthorId = 2, CategoryId = 1,Price = 23});
            context.Books.AddOrUpdate(new Book { Id = 4, Name = "Зеленая миля", Description = "В 1830 году Россию захватила вспышка холеры. Дорога к Москве была перекрыта из-за карантина, и Александр Сергеевич Пушкин оказался в вынужденном затворничестве в имении Большое Болдино. Болдинская осень войдёт в историю как самый продуктивный творческий период писателя. За три месяца он создал около пятидесяти произведений, в том числе и Повести Белкина. Книгу составляют предисловие От издателя и пять повестей: Выстрел, Метель, Гробовщик, Станционный смотритель и Барышня - крестьянка. Издание выполнено с тиснением на обложке, содержит ляссе (ленточку-закладку).", AuthorId = 3, CategoryId = 2,Price = 43});
            context.Books.AddOrUpdate(new Book { Id = 5, Name = "CLR via C#", Description = "В 1830 году Россию захватила вспышка холеры. Дорога к Москве была перекрыта из-за карантина, и Александр Сергеевич Пушкин оказался в вынужденном затворничестве в имении Большое Болдино. Болдинская осень войдёт в историю как самый продуктивный творческий период писателя. За три месяца он создал около пятидесяти произведений, в том числе и Повести Белкина. Книгу составляют предисловие От издателя и пять повестей: Выстрел, Метель, Гробовщик, Станционный смотритель и Барышня - крестьянка. Издание выполнено с тиснением на обложке, содержит ляссе (ленточку-закладку).", AuthorId = 3, CategoryId = 3, Price = 53});
